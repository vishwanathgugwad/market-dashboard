...
const LiveChatCard = ({ contextLabel, marketOpen, floating = false }: LiveChatCardProps) => {
      ...
      <CardHeader
        ...
        action={
          <Stack direction="row" spacing={1} alignItems="center">
            ...
            <Tooltip title={isExpanded ? 'Exit expanded view' : 'Expand view'}>
              <IconButton size="small" onClick={toggleExpanded} disabled={isMinimized}>
